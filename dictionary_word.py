dictionary = {
    'a' : ["Alive : (of a person, animal, or plant) living, not dead.",
           ...
           "Angelic : (of a person) exceptionally beautiful, innocent, or kind.",
    ...
    'b' : ["Balmy : Characterized by pleasantly warm weather.",
           "Brave : Ready to face and endure danger or pain; showing courage.",
           "Beautiful : Pleasing the senses or mind aesthetically.",
           "Benevolent : Well meaning and kindly.",
           "Baggy : (of clothing) loose and hanging in folds.",
    ...
    'c' : ["Clean : Free from dirt, marks, or stains.",
    ...
    'd' : ["Daily : Done, produced, or occurring every day or every weekday.",
           ...
           "Damar : Resin obtained from any of a number of tropical, chiefly Indo-Malaysian trees, used to make varnish.",
    ...
    'e' : ["Ease : Absence of difficulty or effort.",
    ...
    'f' : ["Fable : A story about supernatural or extraordinary persons or incidents; legend.",
           "Faced : Having a face or expression of a specified kind.",
           "Facer : A sudden difficulty.",
           ...
           "Facia : A detachable covering for the front part of a mobile phone.",
    ...
    'g' : ["Gain : Obtain or secure (something wanted or desirable).",
    ...
    'h' : ["Happiness :  A state of well-being that encompasses living a good life, one with a sense of meaning and deep contentment.",
           ...
           "Hadji : A Muslim who has been to Mecca as a pilgrim.",
           "Hamza : (in Arabic script) a symbol representing a glottal stop.",
           "Hammy : (of acting or an actor) exaggerated or over-theatrical.",
           "Haggard : Looking exhausted and unwell, especially from fatigue, worry, or suffering."
           ],
    'i' : ["Index : (in a book or set of books) an alphabetical list of names, subjects, etc. with reference to the pages on which they are mentioned.",
           "Image : A representation of the external form of a person or thing in art.",
           "Inlet : A small arm of the sea, a lake, or a river.",
           "Igloo : An igloo also known as a snow house or snow hut, is a type of shelter built of suitable snow.",
    ...
    'j' : ["Jackpot : A large cash prize in a game or lottery, especially one that accumulates until it is won.",
           ...
           "Jacky : An Aboriginal person."
           ],
    'k' : ["Key : A small piece of shaped metal with incisions cut to fit the wards of a particular lock, which is inserted into a lock and turned to open or close it.",
           "Kennel : A kennel is a structure or shelter for dogs.",
           "Kit : A set of articles or equipment needed for a specific purpose.",
           "Knee : The knee is the largest joint in the body, and one of the most easily injured.",
           ...
           "Kiwi : Kiwifruit or Chinese gooseberry is the edible berry of several species of woody vines in the genus Actinidia.",
           "Kettle : A container or device in which water is boiled, having a lid, spout, and handle.",
           "Kelp : Kelps are large brown algae or seaweeds that make up the order Laminariales."
           ],
    'l' : ["Lean : Be in or move into a sloping position.",
           "Level : A horizontal plane or line with respect to the distance above or below a given point.",
           "Lace : Lace is a delicate fabric made of yarn or thread in an open weblike pattern, made by machine or by hand.",
           ...
           "Lute : A lute is any plucked string instrument with a neck and a deep round back enclosing a hollow cavity, usually with a sound hole or opening in the body."
           ],
    'm' : ["Magnanimous : Generous or forgiving, especially towards a rival or less powerful person.",
           ...
           "Mad : Very enthusiastic about someone or something.",
    ...
    'n' : ["Neat : Arranged in a tidy way; in good order.",
    ...
    'o' : ["Oasis : A fertile spot in a desert, where water is found.",
           ...
           "Oatmeal : Oatmeal is a preparation of oats that have been de-husked, steamed, and flattened, or a coarse flour of hulled oat grains that have either been milled, rolled, or steel-cut.",
    ...
    'p' : ["Patient : Able to accept or tolerate delays, problems, or suffering without becoming annoyed or anxious.",
           "Prize : A thing given as a reward to the winner of a competition or in recognition of an outstanding achievement.",
           "Pragmatics : Pragmatics is the study of how context contributes to meaning.",
    ...
    'q' : ["Quiz : A test of knowledge, especially as a competition between individuals or teams as a form of entertainment.",
           ...
           "Quint : (in piquet) a sequence of five cards of the same suit.",
           "Quill : Any of the main wing or tail feathers of a bird.",
           "Quail : Quail is a collective name for several genera of mid-sized birds generally placed in the order Galliformes."
           ],
    'r' : ["Rail : A bar or series of bars fixed on upright supports or attached to a wall or ceiling, serving as part of a barrier or used to hang things on.",
    ...
    's' : ["Self : A person's essential being that distinguishes them from others, especially considered as the object of introspection or reflexive action.",
    ...
    't' : ["Tub : A wide, open, deep, typically round container with a flat bottom used for holding liquids, growing plants, etc.",
           "Tot : A young child.",
    ...
    'u' : ["Unique : Being the only one of its kind; unlike anything else.",
    ...
    'v' : ["Versatile : Able to adapt or be adapted to many different functions or activities.",
    ...
    'w' : ["Wacky : Funny or amusing in a slightly odd or peculiar way.",
           ...
           "Waltz : A dance in triple time performed by a couple, who as a pair turn rhythmically round and round as they progress around the dance floor.",
           "White : Of the colour of milk or fresh snow, due to the reflection of all visible rays of light; the opposite of black.",
    ...
    'x' : ["Xylophone : The xylophone is a musical instrument in the percussion family that consists of wooden bars struck by mallets.",
           ...
           "Xenial :  Warm, welcoming, and hospitable.",
           "Xanthic : Yellowish.",
           "Xystus : (in ancient Greece) a long portico used by athletes for exercise.",
    ...
    'y' : ["Yacht : A medium-sized sailing boat equipped for cruising or racing.",
           "Yawn : Involuntarily open one's mouth wide and inhale deeply, typically on account of tiredness or boredom.",
           ...
           "Yeah : Non-standard spelling of yes, representing a pronunciation.",
    ...
    'z' : ["Zany : Amusingly unconventional and idiosyncratic.",
           ...
           "Zesty : Having or characterized by zest.",
           "Zeal : Zeal is dedication or enthusiasm for something.",
           "Zarf : A decorative object made of metal and with a handle, used for holding a cup for hot drinks.",
           "Zingy : Strikingly attractive or appealing."
           ]
}
